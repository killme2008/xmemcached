...
/**
 * An unbounded <tt>TransferQueue</tt> based on linked nodes. This queue orders elements FIFO
 ...
 * 
 * <p>
 * Beware that, unlike in most collections, the <tt>size</tt> method is <em>NOT</em> a constant-time
...
public class LinkedTransferQueue<E> extends AbstractQueue<E> implements BlockingQueue<E> {
  ...
  /**
   * Creates a <tt>LinkedTransferQueue</tt> initially containing the elements of the given
