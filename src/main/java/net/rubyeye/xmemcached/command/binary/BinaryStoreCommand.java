...
public class BinaryStoreCommand extends BaseBinaryCommand {
  ...
  public BinaryStoreCommand(String key, byte[] keyBytes, CommandType cmdType, CountDownLatch latch,
    ...
    switch (cmdType) {
      ...
      case SET_MANY:
        ...
        break;
      default:
        throw new IllegalArgumentException("Unknow cmd type for storage commands:" + cmdType);
