...
public class BinaryCASCommand extends BaseBinaryCommand {
  ...
  public BinaryCASCommand(String key, byte[] keyBytes, CommandType cmdType, CountDownLatch latch,
    ...
    switch (cmdType) {
      case CAS:
        ...
        break;
      default:
        throw new IllegalArgumentException("Unknow cas command type:" + cmdType);
    }
