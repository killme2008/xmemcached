...
public class BinaryAppendPrependCommand extends BaseBinaryCommand {
  ...
  public BinaryAppendPrependCommand(String key, byte[] keyBytes, CommandType cmdType,
      CountDownLatch latch, int exp, long cas, Object value, boolean noreply,
    ...
    switch (cmdType) {
      ...
      case PREPEND:
        ...
        break;
      default:
        throw new UnknownCommandException("Not a append or prepend command:" + cmdType.name());
    }
  }
