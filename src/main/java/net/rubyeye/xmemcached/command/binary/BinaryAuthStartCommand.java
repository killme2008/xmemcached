...
public class BinaryAuthStartCommand extends BaseBinaryCommand {
  ...
  public BinaryAuthStartCommand(String mechanism, byte[] keyBytes, CountDownLatch latch,
      byte[] authData) {
    super(mechanism, keyBytes, CommandType.AUTH_START, latch, 0, 0, authData, false, null);
