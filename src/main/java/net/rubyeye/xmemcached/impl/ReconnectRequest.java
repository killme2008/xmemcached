...
public final class ReconnectRequest implements Delayed {
  ...
  public ReconnectRequest(InetSocketAddressWrapper inetSocketAddressWrapper, int tries,
  ...
  public long getDelay(TimeUnit unit) {
    return unit.convert(this.nextReconnectTimestamp - System.currentTimeMillis(),
