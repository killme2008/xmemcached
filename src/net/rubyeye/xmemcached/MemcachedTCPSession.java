...
public class MemcachedTCPSession extends DefaultTCPSession {
    ...
    public MemcachedTCPSession(SocketChannel sc, SelectionKey sk,
            ...
            long sessionTimeout, boolean handleReadWriteConcurrently, boolean optimiezeGet, boolean optimiezeSet) {
    ...
    public void setMergeGetsCount(int mergFactor) {
        this.getsMergeFactor = mergFactor;
    }
