...
public class KetamaMemcachedSessionLocatorNginxUpstreamConsistentUnitTest
  ...
  public void testSessionKey_CompatibleWithNginxUpstreamConsistent() {
    ...
    assertEquals(session1.getRemoteSocketAddress(),
        this.locator.getSessionByKey("127.0.0.1-0").getRemoteSocketAddress());
    assertEquals(session1.getRemoteSocketAddress(),
        this.locator.getSessionByKey("127.0.0.1-1").getRemoteSocketAddress());
    assertEquals(session1.getRemoteSocketAddress(),
        this.locator.getSessionByKey("127.0.0.1-39").getRemoteSocketAddress());

    assertEquals(session2.getRemoteSocketAddress(),
        this.locator.getSessionByKey("127.0.0.1:11212-0").getRemoteSocketAddress());
    assertEquals(session2.getRemoteSocketAddress(),
        this.locator.getSessionByKey("127.0.0.1:11212-1").getRemoteSocketAddress());
    assertEquals(session2.getRemoteSocketAddress(),
        this.locator.getSessionByKey("127.0.0.1:11212-39").getRemoteSocketAddress());

    assertEquals(session3.getRemoteSocketAddress(),
        this.locator.getSessionByKey("127.0.0.1:11213-0").getRemoteSocketAddress());
    assertEquals(session3.getRemoteSocketAddress(),
        this.locator.getSessionByKey("127.0.0.1:11213-1").getRemoteSocketAddress());
    assertEquals(session3.getRemoteSocketAddress(),
        this.locator.getSessionByKey("127.0.0.1:11213-39").getRemoteSocketAddress());
  ...
  public void testSessionKey_CompatibleWithNginxUpstreamConsistent_DefaultPort() {
    ...
    assertEquals(session1.getRemoteSocketAddress(),
        this.locator.getSessionByKey("192.168.1.1-0").getRemoteSocketAddress());
    assertEquals(session1.getRemoteSocketAddress(),
        this.locator.getSessionByKey("192.168.1.1-1").getRemoteSocketAddress());
    assertEquals(session1.getRemoteSocketAddress(),
        this.locator.getSessionByKey("192.168.1.1-39").getRemoteSocketAddress());

    assertEquals(session2.getRemoteSocketAddress(),
        this.locator.getSessionByKey("192.168.1.2-0").getRemoteSocketAddress());
    assertEquals(session2.getRemoteSocketAddress(),
        this.locator.getSessionByKey("192.168.1.2-1").getRemoteSocketAddress());
    assertEquals(session2.getRemoteSocketAddress(),
        this.locator.getSessionByKey("192.168.1.2-39").getRemoteSocketAddress());

    assertEquals(session3.getRemoteSocketAddress(),
        this.locator.getSessionByKey("192.168.1.3-0").getRemoteSocketAddress());
    assertEquals(session3.getRemoteSocketAddress(),
        this.locator.getSessionByKey("192.168.1.3-1").getRemoteSocketAddress());
    assertEquals(session3.getRemoteSocketAddress(),
        this.locator.getSessionByKey("192.168.1.3-39").getRemoteSocketAddress());
