...
public class XMemcachedMBeanServerUnitTest extends TestCase {
  ...
  public void testMBeanServer() throws Exception {
    Method method = XMemcachedMbeanServer.getInstance().getClass().getDeclaredMethod("initialize",
        new Class[] {});
    ...
    String name =
        mock.getClass().getPackage().getName() + ":type=" + mock.getClass().getSimpleName();
