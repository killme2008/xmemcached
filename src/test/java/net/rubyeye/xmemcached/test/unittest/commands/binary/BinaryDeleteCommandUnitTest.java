...
public class BinaryDeleteCommandUnitTest extends BaseBinaryCommandUnitTest {
  ...
  public void testDeleteEncodeAndDecode() {
    ...
    Command command =
        this.commandFactory.createDeleteCommand(this.key, this.keyBytes, 0, 999L, this.noreply);
    command.encode();
    ...
    ByteBuffer buffer = this.constructResponse(OpCode.DELETE.fieldValue(), (short) 0, (byte) 0,
    ...
    buffer = this.constructResponse(OpCode.DELETE.fieldValue(), (short) 0, (byte) 0, (byte) 0,
