...
public class MockMemcachedClientStateListener implements MemcachedClientStateListener {
  AtomicInteger num;
  ...
  public void onDisconnected(MemcachedClient memcachedClient, InetSocketAddress inetSocketAddress) {
    this.num.incrementAndGet();
    System.out.println(
        "Disconnected to " + inetSocketAddress.getHostName() + ":" + inetSocketAddress.getPort());
  }
