...
public class MockDecodeTimeoutBinaryGetOneCommand extends BinaryGetCommand {
  ...
  public MockDecodeTimeoutBinaryGetOneCommand(String key, byte[] keyBytes, CommandType cmdType,
      CountDownLatch latch, OpCode opCode, boolean noreply, long sleepTime) {
