...
public class BinaryTouchCommandUnitTest extends BaseBinaryCommandUnitTest {
  ...
  public void testEncodeDecode() {
    Command command = this.commandFactory.createTouchCommand(key, keyBytes, null, 10, false);
    command.encode();
    ...
    ByteBuffer buffer = constructResponse(OpCode.TOUCH.fieldValue(), (short) 0, (byte) 0, (byte) 0,
    ...
    buffer = constructResponse(OpCode.TOUCH.fieldValue(), (short) 0, (byte) 0, (byte) 0,
        (short) 0x0005, 0, 0, 1L, null, null, null);
    command = this.commandFactory.createTouchCommand(key, keyBytes, null, 10, false);
    assertTrue(command.decode(null, buffer));
