...
public class BinaryCASCommandUnitTest extends BaseBinaryCommandUnitTest {
  ...
  public void testAddEncodeAndDecode() {
    ...
    Command command = this.commandFactory.createCASCommand(this.key, this.keyBytes, 0, this.value,
    ...
    ByteBuffer buffer = constructResponse(OpCode.SET.fieldValue(), (short) 0, (byte) 0, (byte) 0,
        (short) 0, 0, 0, 10L, null, null, null);
    ...
    buffer = constructResponse(OpCode.SET.fieldValue(), (short) 0, (byte) 0, (byte) 0,
        (short) 0x0005, 0, 0, 0L, null, null, null);
    command = this.commandFactory.createCASCommand(this.key, this.keyBytes, 0, this.value, 9L,
