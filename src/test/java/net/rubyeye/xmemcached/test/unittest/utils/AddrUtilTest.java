...
public class AddrUtilTest extends TestCase {
  public void testGetAddresses() {
    ...
    List<InetSocketAddress> addresses = AddrUtil.getAddresses("localhost:12000 192.168.0.98:12000");
  ...
  public void testGetAddressMap_OnlyMainAddr() {
    Map<InetSocketAddress, InetSocketAddress> addressMap =
        AddrUtil.getAddressMap("localhost:12000 localhost:12001 localhost:12002 ");
  ...
  public void testGetAddressMap() {
    Map<InetSocketAddress, InetSocketAddress> addressMap = AddrUtil.getAddressMap(
