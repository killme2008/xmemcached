...
public class TextIncrDecrCommandUnitTest extends BaseTextCommandUnitTest {
  public void testEncodeIncr() {
    Command command = this.commandFactory.createIncrDecrCommand("test", "test".getBytes(), 10, 0, 0,
    ...
    command = this.commandFactory.createIncrDecrCommand("test", "test".getBytes(), 10, 0, 0,
