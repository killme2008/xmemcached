...
public class TextVerbositylCommandUnitTest extends BaseTextCommandUnitTest {
	public void testEncode() {
		Command command = this.commandFactory
				.createVerbosityCommand(new CountDownLatch(1), 1, false);
		...
		command = this.commandFactory
				.createVerbosityCommand(new CountDownLatch(1), 1, true);
		command.encode();
	...
	public void testDecode() {
		Command command = this.commandFactory
				.createVerbosityCommand(new CountDownLatch(1), 0, false);
