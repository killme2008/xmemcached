...
public class BinaryStatsCommandUnitTest extends BaseBinaryCommandUnitTest {
  public void testEncodeDecode() {
    Command command = this.commandFactory.createStatsCommand(new InetSocketAddress("localhost", 80),
    ...
    for (int i = 0; i < buffers.length; i++) {
      ...
      buffers[i] = constructResponse(OpCode.STAT.fieldValue(), (short) key.length(), (byte) 0,
          (byte) 0, (short) 0, 2 * key.length(), 0, 0L, null, key.getBytes(), key.getBytes());
    ...
    totalBuffer.put(constructResponse(OpCode.STAT.fieldValue(), (short) 0, (byte) 0, (byte) 0,
        (short) 0, 0, 0, 0L, null, null, null));
    totalBuffer.flip();
