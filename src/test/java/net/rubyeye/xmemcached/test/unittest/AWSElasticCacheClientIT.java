...
public class AWSElasticCacheClientIT extends TestCase {
  ...
  public void setUp() throws Exception {
    Properties properties = ResourcesUtils.getResourceAsProperties("test.properties");
    ...
    for (InetSocketAddress addr : addresses) {
      ...
      sb.append(addr.getHostName() + "|" + addr.getHostName() + "|" + addr.getPort());
  ...
  public void testPollConfigInterval() throws Exception {
    ...
    cs2.setHandler(
        new MockHandler(version + 1, "localhost|localhost|2271 localhost|localhost|2272"));
