...
public class BinaryGetAndTouchCommandUnitTest extends BaseBinaryCommandUnitTest {
  ...
  public void testGetEncodeAndDecode() {
    ...
    Command command =
        this.commandFactory.createGetAndTouchCommand(this.key, this.keyBytes, null, 10, false);
    ...
    ByteBuffer buffer = constructResponse(OpCode.GAT.fieldValue(), (short) 0, (byte) 0x04, (byte) 0,
    ...
    buffer = constructResponse(OpCode.GAT.fieldValue(), (short) 0, (byte) 0x04, (byte) 0, (short) 0,
