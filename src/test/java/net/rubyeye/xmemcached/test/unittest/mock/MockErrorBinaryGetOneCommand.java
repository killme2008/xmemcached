...
public class MockErrorBinaryGetOneCommand extends BinaryGetCommand implements MockErrorCommand {

  private boolean decode;

  public MockErrorBinaryGetOneCommand(String key, byte[] keyBytes, CommandType cmdType,
