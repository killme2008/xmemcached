...
public class BinaryStoreCommandUnitTest extends BaseBinaryCommandUnitTest {
  ...
  public void testAddEncodeAndDecode() {
    ...
    Command command = this.commandFactory.createAddCommand(this.key, this.keyBytes, 0, this.value,
    ...
    ByteBuffer buffer = constructResponse(OpCode.ADD.fieldValue(), (short) 0, (byte) 0, (byte) 0,
        (short) 0, 0, 0, 1L, null, null, null);

    assertTrue(command.decode(null, buffer));
    assertTrue((Boolean) command.getResult());
    assertEquals(0, buffer.remaining());

    buffer = constructResponse(OpCode.ADD.fieldValue(), (short) 0, (byte) 0, (byte) 0,
        (short) 0x0005, 0, 0, 1L, null, null, null);
  ...
  public void testReplaceEncodeAndDecode() {
    ...
    Command command = this.commandFactory.createReplaceCommand(this.key, this.keyBytes, 0,
    ...
    ByteBuffer buffer = constructResponse(OpCode.REPLACE.fieldValue(), (short) 0, (byte) 0,
        (byte) 0, (short) 0, 0, 0, 1L, null, null, null);

    assertTrue(command.decode(null, buffer));
    assertTrue((Boolean) command.getResult());
    assertEquals(0, buffer.remaining());

    buffer = constructResponse(OpCode.REPLACE.fieldValue(), (short) 0, (byte) 0, (byte) 0,
        (short) 0x0005, 0, 0, 1L, null, null, null);
  ...
  public void testSetEncodeAndDecode() {
    ...
    Command command = this.commandFactory.createSetCommand(this.key, this.keyBytes, 0, this.value,
        this.noreply, this.transcoder);
    ...
    ByteBuffer buffer = constructResponse(OpCode.SET.fieldValue(), (short) 0, (byte) 0, (byte) 0,
        (short) 0, 0, 0, 1L, null, null, null);
    ...
    buffer = constructResponse(OpCode.SET.fieldValue(), (short) 0, (byte) 0, (byte) 0,
        (short) 0x0005, 0, 0, 1L, null, null, null);
