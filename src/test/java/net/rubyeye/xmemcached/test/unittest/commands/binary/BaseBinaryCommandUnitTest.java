...
public class BaseBinaryCommandUnitTest extends TestCase {
  ...
  public ByteBuffer constructResponse(byte opCode, short keyLength, byte extraLength, byte dataType,
      short status, int totalBodyLength, int opaque, long cas, byte[] extras, byte[] keyBytes,
      byte[] valueBytes) {
